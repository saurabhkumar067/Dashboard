...
function Navbar() {
  return (
    <nav>
      <div className="bg-[#252525] h-full pb-4 pt-2 flex flex-col items-center fixed w-[20%]">
        <div className="logo mb-9">
          <img src={BlackLogo} className="w-40" alt="" />
        </div>
        <ul className="text-lg flex flex-col  gap-3 font-bold w-full text-center">
          <li>
            <NavLink
              ...
              className={(e) => {
                return e.isActive
                  ? `py-2 px-4  rounded-full bg-custom-gradient`
                  : ``;
              }}
            >
              Dashboard
        ...
        <div className="apps flex flex-col justify-end h-full gap-2">
          ...
          <div className="text-gray-200">Copyright &copy; BitPayME</div>
          <div className="flex gap-0 text-xl">
            <TiChevronRight style={{ fontWeight: "900" }} />
            <TiChevronRight />
            <TiChevronRight />
          </div>
        </div>
